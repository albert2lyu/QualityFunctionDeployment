...
#include <QComboBox>
#include <QFileDialog>
TableOneForm::TableOneForm(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TableOneForm)
{
    ui->setupUi(this);
...
void TableOneForm::on_pushButton_clicked()
{
...
void TableOneForm::on_pushButton_2_clicked()
{
...
//将表格数据写入文件
void TableOneForm::on_pushButton_3_clicked()
{
...
//将文件数据导入表格
void TableOneForm::on_pushButton_4_clicked()
{
