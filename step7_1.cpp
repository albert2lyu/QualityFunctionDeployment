    ...
    ui(new Ui::Step7_1)
{
    ...
    m_Header<<QString("价值指标1")<<QString("价值指标2")<<QString("价值指标3");
    ...
    HStrList.push_back(QString("价值指标4"));
    ...
    for(int i=0;i<ColumnNum*RowNum*3;i++)
    {
        ...
        { QComboBox *tmp= new QComboBox();
            ...
            tmp->addItem("类型六");
            Combox.append(tmp);}
        else if(i%3==1){QComboBox *tmp= new QComboBox();
            tmp->addItem("1");
            tmp->addItem("2");
            tmp->addItem("3");
            tmp->addItem("4");
            ...
            Combox.append(tmp);
        }        else if(i%3==2){QComboBox *tmp= new QComboBox();
            tmp->addItem("1");
            Combox.append(tmp);
        }
    ...
    for(int i=0;i<ColumnNum*RowNum;i++)
    {
        ...
        for (int i=0;i<3;i++) {
            if(i%3==2){
                ...
                verticalLayout->addWidget(line);ss++;
            }else
