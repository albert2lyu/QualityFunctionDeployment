...
Step9_2::Step9_2(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Step9_2)
{
    ui->setupUi(this);
    ...
    setWindowTitle(tr("TableWidget"));//设置对话框的标题
       ...
       ui->qTableWidget->horizontalHeader()->setVisible(true);//横向表头可视化
        ...
        HStrList.push_back(QString("质量参数"));
...
void Step9_2::on_pushButton_clicked()
{
...
void Step9_2::on_pushButton_2_clicked()
{
...
//将表格数据写入文件
void Step9_2::on_pushButton_3_clicked()
{
...
//将文件数据导入表格
void Step9_2::on_pushButton_4_clicked()
{
...
void Step9_2::on_pushButton_5_clicked()
{

   QExcelEngine excelEngine=*new QExcelEngine();

  QString filename =  QDir::tempPath() + QDir::separator() +QCoreApplication::applicationName() + "Step9_2_temp" + "xls";
  if(filename.isEmpty())
      return;
  QFile file(filename);
