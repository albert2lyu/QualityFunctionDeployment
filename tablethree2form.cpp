...
#include "ui_tablethree2form.h"
#include <QTableWidget>
#include <QTableWidgetItem>
#include <QDebug>
#include <QComboBox>
TableThree2Form::TableThree2Form(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TableThree2Form)
{
    ui->setupUi(this);
    int RowNum=10;
    int ColumnNum=5;
    ...
    HStrList.push_back(QString("当前位次"));
    HStrList.push_back(QString("期望位次"));
...
TableThree2Form::~TableThree2Form()
{
    delete ui;
}

void TableThree2Form::on_pushButton_clicked(){}
void TableThree2Form::on_pushButton_2_clicked(){}
void TableThree2Form::on_pushButton_3_clicked(){}
void TableThree2Form::on_pushButton_4_clicked(){}
void TableThree2Form::on_pushButton_5_clicked(){}
